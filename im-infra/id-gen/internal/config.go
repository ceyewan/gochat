...
func (c *Config) Validate() error {
	...
	case SnowflakeType:
		if c.Snowflake == nil {
			return fmt.Errorf("snowflake config is required for snowflake type")
		}
		return c.Snowflake.Validate()
		
	case UUIDType:
		if c.UUID == nil {
			return fmt.Errorf("uuid config is required for uuid type")
		}
		return c.UUID.Validate()
		
	case RedisType:
		if c.Redis == nil {
			return fmt.Errorf("redis config is required for redis type")
		}
